...
function addClasses(button) {
    ...
    const btnOpClass = "hover:bg-red-500 border-blue-500";
...
//  flex w-12 h-12 justify-center items-center m-1 font-bold py-2 px-2 border hover:border-transparent rounded text-white border-2 text-2x1 
